...
### Setting the VScode and Copilot.
...
* setup copilot account

### Setting Rhino/Grasshopper 

* If you have not done before, open once Grasshopper and a Python block and wait for it to load. Then double click in.
* Go on top bar to Tools, then Options.
Top bar go to Python 3.
*Below in module search paths select plus and add the path to your cdf source folder which looks like: C:\Users\your_username\workspace\cdf1_teaching\src
save
